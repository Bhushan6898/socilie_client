...
import SuggestUserHomepage from './suggestforHomepage';
...
function UserProfile() {
  ...
  const { allUsers, getallusers,setting } = useAdmin();
  ...
  useEffect(() => {
    if (allUsers.length > 0 && id) {
      ...
      setSelectusersetting(selectedUser?.settings.privacy?.isPrivateAccount);
      ...
      <div className="mb-4">
        {selectusersetting === true ? (
          ...
          <div className="container d-flex justify-content-center align-items-center mb-4">
            <div className="card text-center p-4 shadow-sm" style={{ maxWidth: '300px' }}>
              <img
              src="https://static.thenounproject.com/png/4020631-200.png"
                alt="Lock Icon"
                className="mx-auto mb-1"
                style={{ width: '40px' }}
              />
              <h5 className="card-title mb-1">This Account is Private</h5>
